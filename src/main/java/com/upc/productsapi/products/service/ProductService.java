...
public class ProductService implements IProductService {
    ...
    @Override
    public ApiResponse<ProductResponseDto> getProductByProductId(long productId) {
        //buscar el producto
        var product = productRepository.findByProductId(productId)
                .orElseThrow(() -> new ResourceNotFoundException("No se encontró el producto con el nombre: " + productId));
